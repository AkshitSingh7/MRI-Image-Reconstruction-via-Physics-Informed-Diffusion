...
> **High-fidelity MRI reconstruction from 4x undersampled data using a Physics-Informed Conditional Diffusion Model. Implements a spectral Data Consistency (DC) layer during inference to enforce K-Space validity, achieving a +6.04 dB PSNR improvement.**
...
| --- | --- | --- | --- |
| **PSNR** (Peak Signal-to-Noise Ratio) | 24.12 dB | **30.16 dB** | **+6.04 dB** 🚀 |
...
* **Logic:** At every denoising step , the predicted image is projected into K-Space.
...
│   └── reconstruction_comparison.png  # Result visualization
├── src/
...
```bash
git clone https://github.com/AkshitSingh7/MRI-Image-Reconstruction-via-Physics-Informed-Diffusion.git
...
@misc{singh2024mridiffusion,
  ...
  howpublished = {\url{https://github.com/AkshitSingh7/MRI-Image-Reconstruction-via-Physics-Informed-Diffusion}}
}
